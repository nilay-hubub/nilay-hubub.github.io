...
class Marvy_Animation_Addons_Elementor
{
    ...
    public function enqueue_scripts($id = 0)
    {
        ...
        wp_localize_script('marvy-fancy-rotate', 'marvyScript', array('pluginsUrl' => plugin_dir_url(__FILE__)));
        wp_localize_script('marvy-firework-animation', 'marvyScript', array('pluginsUrl' => plugin_dir_url(__FILE__)));
    }
}
