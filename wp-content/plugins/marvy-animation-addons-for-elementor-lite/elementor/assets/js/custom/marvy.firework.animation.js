    ...
    var MarvyFireworkAnimation = {
        ...
        initFireworkWidget: function ($scope) {
            ...
            if (window.isEditMode || window.elementorFrontend.isEditMode()) {
                ...
                $.each(editorElements.models, function (i, el) {
                    ...
                    settings.color_multiples = fireworkAnimationArgs.marvy_firework_animation_color_multiples;
        ...
        loadFireworks: function (target, sectionId, settings) {
            ...
            if (checkElement.length >= 0) {
                ...
                const fireworkZindex = document.querySelector('.marvy-custom-firework-animation-section-' + sectionId + ' .elementor-container');
                fireworkZindex.style.zIndex = '99';

                // Set min height
                const fireworkMinHeight = document.querySelector(".elementor-element-" + sectionId);
                fireworkMinHeight.closest('.elementor-top-section').style.minHeight = "100px";
                // Canvas Setup End

                if((typeof settings.color_multiples) === 'string') {
                    settings.color_multiples = settings.color_multiples.split("--,--");
                }else {
                    settings.color_multiples = [];
                }
